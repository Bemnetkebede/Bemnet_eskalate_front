        ...
        <LayOut>
            <div>
                <div className="flex">
                    ...
                    <div>
                        {
                            basket.length > 0 &&  <div className="my-2 mx-10 visible basis-2/4">
                ...
                {basket?.length > 0 ? (
                    <div className="basket-items">
                        ...
                        <div key={index} className="grid grid-cols-2 items-center my-4 gap-96">
                            ...
                            <div className="quantity-controls space-x-2 mt-[-47%]">
                            <button
                    ...
                    <div className="empty-cart flex flex-col justify-center items-center space-y-5">
                        <p className="text-center font-bold text-3xl">Oops! No items in your cart!</p>
                        <Link to="/">
                        <button className="bg-[rgb(232,151,59)] rounded-md px-5 py-2 hover:text-white">
                            Click here to Add
                        </button>
                        </Link>
                    </div>
